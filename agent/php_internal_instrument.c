...
#define NR_INTERNAL_WRAPREC(FULL_NAME, OUTER, INNER, DISABLED, EXTRA) \
  ...
  NR_INTERNAL_WRAPREC("redis::publish", redis_publish, redis_function, 0, "publish")
  ...
  NR_INTERNAL_WRAPREC("redis::hgetall", redis_hgetall, redis_function, 0, "hgetall")
  ...
  NR_INTERNAL_WRAPREC("redis::sdel", redis_sdel, redis_function, 0, "sdel")
  ...
  NR_INTERNAL_WRAPREC("redis::xreadgroup", redis_xreadgroup, redis_function, 0, "xreadgroup")
  ...
  NR_INTERNAL_WRAPREC("redis::zrangebyscore", redis_zrangebyscore, redis_function, 0, "zrangebyscore")
